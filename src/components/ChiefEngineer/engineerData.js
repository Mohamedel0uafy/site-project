...
export const engineer = {
  ...
  bio: `Fondateur et directeur technique de BCGC S.A.R.L, My Ahmed EL Idrissi a consacré plus de 30 ans à la maîtrise du béton armé, de l'analyse structurelle et du contrôle technique de bâtiments complexes. Il a supervisé des projets allant des infrastructures publiques aux tours résidentielles R+12, en passant par des ouvrages d'art en zones sismiques. Son approche combine rigueur normative (RPA 99, DTR, Eurocode) et pragmatisme terrain.`,
  stats: [
    { value: '30+', label: "Années d'expérience" },
    { value: '700+', label: 'Projets supervisés' },
